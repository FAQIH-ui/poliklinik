<aside class="w-full bg-transparent text-slate-300 flex flex-col min-h-screen">
    ...
    <div class="flex-1 overflow-y-auto px-3 py-4">
        ...
        @if(request()->is('admin*'))
            ...
            <div class="space-y-1">
                ...
                {{-- Menu Manajemen Poli Sesuai Instruksi --}}
    ...
    <div class="p-4 border-t border-white/10">
        <form method="POST" action="/logout">
            @csrf
            <button type="submit" class="w-full flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg bg-red-500 hover:bg-red-600 text-white font-semibold transition-all">
